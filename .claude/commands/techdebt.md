...
1. Search for TODO, FIXME, HACK, and XXX comments across the codebase.
...
5. Identify dependencies that are significantly outdated (check package.json or requirements.txt).
6. Look for inconsistent patterns (e.g. some files use one approach, others use another for the same thing).
